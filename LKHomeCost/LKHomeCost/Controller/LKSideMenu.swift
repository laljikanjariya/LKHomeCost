...
class LKSideMenu: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        sideMenuController?.cache(viewControllerGenerator: {
            self.storyboard?.instantiateViewController(withIdentifier: "LKTimeLineNVC_sid")
        }, with: "0")
        
        sideMenuController?.cache(viewControllerGenerator: {
            self.storyboard?.instantiateViewController(withIdentifier: "LKSummaryNVC_sid")
        }, with: "1")
...
extension LKSideMenu: SideMenuControllerDelegate {
...
extension LKSideMenu: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if row == 0 {
            cell.titleLabel?.text = "Time-Line"
        } else if row == 1 {
